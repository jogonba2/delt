"""Module for the base video encoder."""
...
class VideoEncoder(Encoder):
    ...
    def processor(self) -> PreTrainedTokenizerBase | ProcessorMixin | None:
        """
        Processor tied to a video encoder.
    ...
    def encoder(self) -> PreTrainedModel:
        """
        A pretrained video encoder model.

        Returns:
            PreTrainedModel: the pretrained video encoder.
