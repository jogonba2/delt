...
class SiglipEncoder(ImageEncoder):
    """Image encoder model that uses a pre-trained Siglip encoder."""
    ...
    def encoder(self) -> PreTrainedModel:
        """
        A pretrained SigLip encoder model.

        Returns:
            PreTrainedModel: the pretrained SigLip encoder.
    ...
    def get_text_embeddings(
        ...
        """
        Embed a list of texts using the SigLip's text encoder model.
